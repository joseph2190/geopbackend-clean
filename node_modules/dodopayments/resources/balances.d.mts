...
export interface BalanceLedgerEntry {
    ...
    event_type: 'payment' | 'refund' | 'refund_reversal' | 'dispute' | 'dispute_reversal' | 'tax' | 'tax_reversal' | 'payment_fees' | 'refund_fees' | 'refund_fees_reversal' | 'dispute_fees' | 'payout' | 'payout_fees' | 'payout_reversal' | 'payout_fees_reversal' | 'dodo_credits' | 'adjustment' | 'currency_conversion';
    is_credit: boolean;
