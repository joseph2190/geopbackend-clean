...
class DodoPayments {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('DODO_PAYMENTS_BASE_URL'), bearerToken = (0, env_1.readEnv)('DODO_PAYMENTS_API_KEY'), webhookKey = (0, env_1.readEnv)('DODO_PAYMENTS_WEBHOOK_KEY') ?? null, ...opts } = {}) {
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('DODO_PAYMENTS_LOG'), "process.env['DODO_PAYMENTS_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _DodoPayments_encoder, Opts.FallbackEncoder, "f");
    ...
    async authHeaders(opts) {
        return (0, headers_1.buildHeaders)([{ Authorization: `Bearer ${this.bearerToken}` }]);
    }
    /**
    ...
    stringifyQuery(query) {
        return Object.entries(query)
            ...
            throw new Errors.DodoPaymentsError(`Cannot stringify type ${typeof value}; Expected string, number, boolean, or null. If you need to pass nested query parameters, you can manually encode them, e.g. { query: { 'foo[key1]': value1, 'foo[key2]': value2 } }, and please open a GitHub issue requesting better support for your use case.`);
        })
            .join('&');
    }
    getUserAgent() {
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _DodoPayments_instances, "m", _DodoPayments_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _DodoPayments_encoder, "f").call(this, { body, headers });
        }
    }
}
...
DodoPayments.Balances = balances_1.Balances;
